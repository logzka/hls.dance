  ...
  return (
      <section className="hero h-screen">
        ...
        <Container className="relative h-full flex flex-col items-center justify-center">
          <h1 className="text-center text-3xl sm:text-8xl mb-16"><span className="text-accent">хочу</span>танцевать</h1>
        ...
        <div className="absolute left-40 sm:left-[unset] sm:right-32 -bottom-4 bg-yellow-100 shadow-lg shadow-green-300/40 transition-all cursor-pointer hover:rotate-0 hover:shadow-none rotate-15 rounded-full px-4 sm:px-8 py-2 sm:py-4 flex items-center justify-center"><p className="text-center font-bold uppercase text-accent text-sm sm:text-base">Пробное<br/>бесплатно</p></div>
      </section>
  )
}
