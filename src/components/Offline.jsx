...
const Offline = () => {
    ...
    <Container>
      ...
      <FlipContextProvider>
        <div className="flip-wrapper grid sm:grid-cols-2 gap-4 mb-16">
          <FlipCard
            className="w-full h-[500px] sm:h-[440px]"
            index={1}
            frontChild={
              <div className="h-full bg-accent rounded-sm p-4 sm:p-8 shadow-accent/40 shadow-2xl">
            ...
            backChild={
              <div className="h-full border-8 border-accent bg-dark rounded-sm p-4 sm:p-8">
                <ArticleTitle className='text-dark bg-green-300 rounded-sm w-fit'>Начинающие</ArticleTitle>
                <ul className="pl-4 grid gap-2.5">
          ...
          <FlipCard
            ...
            backChild={
              <div className="h-full border-8 border-accent bg-dark rounded-sm p-4 sm:p-8">
                <ArticleTitle className='text-dark bg-green-300 rounded-sm w-fit'>Продолжающие</ArticleTitle>
                <ul className="pl-4 mb-8 grid gap-2.5">
